...
<html lang="en">
	<head>
		...
		************ -->
		...
		<link rel="stylesheet" href="{{url('design/fonts/style.css')}}">
		...
		************ -->
		...
		<!-- Mega Menu -->
		<link rel="stylesheet" href="{{url('design/vendor/megamenu/css/megamenu.css')}}">

		<!-- Search Filter JS -->
		<link rel="stylesheet" href="{{url('design/vendor/search-filter/search-filter.css')}}">
		<link rel="stylesheet" href="{{url('design/vendor/search-filter/custom-search-filter.css')}}">
		
		 <!-- Data Tables -->
		 <link rel="stylesheet" href="{{url('design/vendor/datatables/dataTables.bs4.css')}}" />
		<link rel="stylesheet" href="{{url('design/vendor/datatables/dataTables.bs4-custom.css')}}" />
		<link rel="stylesheet" href="{{url('design/vendor/datatables/buttons.bs.css')}}" />
			...
			<nav class="sidebar-wrapper">
				...
				<div class="sidebar-tabs">
					...
					<div class="nav" role="tablist" aria-orientation="vertical">
						<a href="#" class="logo">
							<img src="{{url('design/img/logo.svg')}}" alt="Uni Pro Admin">
						</a>
					...
					<div class="tab-content">
						...
						<div class="tab-pane fade show active" id="tab-home" role="tabpanel" aria-labelledby="home-tab">
							...
							<a href="{{'site'}}" class="current-page">Dashboard</a>
							</div>
							...
							<ul class="header-actions">
										...
										<div class="customScroll">
											<ul class="header-notifications">
												<li>
													<a href="#">
														<div class="user-img online">
															<img src="{{url('design/img/user6.png')}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img busy">
															<img src="{{url('design/img/user10.png')}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img away">
															<img src="{{url('design/img/user21.png')}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img busy">
															<img src="{{url('design/img/user15.png')}}" alt="User">
														</div>
														<div class="details">
												...
												<li>
													<a href="#">
														<div class="user-img online">
															<img src="{{url('design/img/user5.png')}}" alt="User">
														</div>
														<div class="details">
								...
								<li class="dropdown">
									<a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
										<span class="avatar">
											<img src="{{url('design/img/user.svg')}}" alt="User Avatar">
									...
									<div class="dropdown-menu dropdown-menu-end md" aria-labelledby="userSettings">
										<div class="header-profile-actions">
											...
											<i> <a class="dropdown-item" style="margin-top: 15px; font-weight: 700;" href="{{ route('logout') }}"
