											...
											<table class="table products-table">
												...
												<tbody>
													<tr>
														...
														<td>20/11/2020</td>
														<td>
															<img class="user" src="{{url('design/img/products/bag.jpeg')}}" alt="Product Image">
														</td>
														<td>
													...
													<tr>
														...
														<td>23/11/2020</td>												
														<td>
															<img class="user" src="{{url('design/img/products/toy.jpeg')}}" alt="Product Image">
														</td>
														<td>
													...
													<tr>
														...
														<td>26/11/2020</td>												
														<td>
															<img class="user" src="{{url('design/img/products/pencils.jpeg')}}" alt="Product Image">
														</td>
														<td>
													...
													<tr>
														...
														<td>25/11/2020</td>
														<td>
															<img class="user" src="{{url('design/img/products/camera.jpeg')}}" alt="Product Image">
														</td>
														<td>
